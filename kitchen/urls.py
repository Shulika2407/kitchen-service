...
from .views import (
    ...
    CookListView,
    IngredientListView,
    CookDetailView, DishDetailView,
    DishCreateView, DishUpdateView,
    DishDeleteView, CookCreateView,
...
urlpatterns = [
    ...
    path("dishtype/<int:pk>/update/",
         DishTypeUpdateView.as_view(),
         name="dish-type-update",
         ),
    path("dishtype/<int:pk>/delete/",
    ...
    path("dish/<int:pk>/toggle-assign/", toggle_assign_to_dish,
